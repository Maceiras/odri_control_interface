...
typedef const Eigen::Ref<const Eigen::Matrix<int, Eigen::Dynamic, 1>> ConstRefVectorXi;
typedef const Eigen::Ref<const Eigen::Matrix<long, Eigen::Dynamic, 1>> ConstRefVectorXl;
typedef const Eigen::Ref<const Eigen::Matrix<bool, Eigen::Dynamic, 1>> ConstRefVectorXb;
typedef const Eigen::Ref<const Eigen::Matrix<double, Eigen::Dynamic, 1>> ConstRefVectorXd;
